...
River Admin is a very modern and shiny web application that provides
administration for django-river_ .  It can either be
deployed as standalone or bundled in your application
