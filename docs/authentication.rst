...
.. note::
    ...
    an admin user or having ``river_workflow.view`` permissions.
    So to speak, ``river_workflow.view`` is the minimum required
    permission to be able to user ``River Admin``
